 ...
 * @returns {number}
 */
function count_combos(range_str) {
    const ptr0 = passStringToWasm0(range_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.count_combos(ptr0, len0);
    return ret >>> 0;
}
exports.count_combos = count_combos;
 ...
 * @returns {number}
 */
function equity_vs(hand_a, hand_b) {
    const ptr0 = passStringToWasm0(hand_a, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(hand_b, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.equity_vs(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
}
exports.equity_vs = equity_vs;
 ...
 * @returns {number}
 */
function equity_vs_range_flop(hero_combo, villain_range, flop) {
...
exports.equity_vs_range_flop = equity_vs_range_flop;
...
const wasmPath = `${__dirname}/engine_bg.wasm`;
